...
**Runnable product demos:** [pranavv-product-demos](https://github.com/pranavvrajamani9-lgtm/pranavv-product-demos) — five original, synthetic demos with a clear public/private boundary. Includes a full-stack local API reference with guarded state transitions, idempotency, audit events, and automated tests.
